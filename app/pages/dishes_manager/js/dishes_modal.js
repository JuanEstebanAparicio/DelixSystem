      ...
      selected.forEach(id => {
        ...
        const block = `
          <div class="ingredient-quantity-block" data-ing="${id}">
            ...
            <input type="number" step="1" name="quantity_${id}" id="${inputId}" placeholder="Ej: 2">
            ${unitControlHTML}
          </div>
        `;
      ...
      data.ingredients.forEach(ing => {
        ...
        container.append(`
          <div class="ingredient-quantity-block" data-ing="${ing.id}">
            ...
            <input type="number" step="1" name="quantity_${ing.id}" id="${inputId}" value="${quantityVal}">
            ${unitControlHTML}
          </div>
        `);
      });
