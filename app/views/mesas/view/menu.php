...
// Si hay sesión, usar el nombre del restaurante del usuario logueado
if (isset($_SESSION['usuario'])) {
    $usuario = $_SESSION['usuario'];
    $restaurant_name = $usuario['restaurant_name'] ?? 'Mi Restaurante';
} else {
    // Si no hay sesión, usar un nombre por defecto
    $restaurant_name = 'Restaurante Delix';
}
